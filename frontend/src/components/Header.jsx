  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center mr-2">
        ...
        />
        <h1
          className="text-[24px] font-semibold px-4 sm:block hidden cursor-pointer"
          onClick={() => navigate("/app")}
        >
          {brandName.name}
        </h1>
      ...
      <div className="relative flex flex-row cursor-pointer border-4 hover:border-4 hover:border-blue-600 border-blue-400 rounded-full md:ml-28 ml-2"
