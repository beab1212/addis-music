    ...
    <section className="">
      ...
      <div className="flex flex-wrap gap-5 justify-between relative z-[5] m-4 customScroll overflow-hidden overflow-y-scroll scroll-smooth">
        {/* {data?.map((song) => (
          <div
            key={song._id}
            className={`flex relative rounded-lg cursor-pointer overflow-hidden hover:bg-gray-800 md:w-[10rem] w-[6rem] ${
          ...
          >
            ...
            <div className="absolute hover:flex flex top-0 items-center justify-center w-full h-full">
              <div
                className={`flex items-center justify-center rounded-full w-10 h-10 bg-[#1194c8] shadow-lg shadow-gray-900 pl-[0.3rem] overflow-hidden ${
